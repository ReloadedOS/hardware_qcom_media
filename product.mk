...
include hardware/qcom/$(QCOM_HARDWARE_VARIANT)/media/conf_files/$(TARGET_BOARD_PLATFORM)/$(TARGET_BOARD_PLATFORM).mk
else ifeq ($(TARGET_BOARD_PLATFORM), sdmshrike)
include hardware/qcom/$(QCOM_HARDWARE_VARIANT)/media/conf_files/msmnile/msmnile.mk
endif
